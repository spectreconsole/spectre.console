...
public sealed class CommandApp<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TDefaultCommand> : ICommandApp
...
/// </summary>
/// <typeparam name="TDefaultCommand">The type of the default command.</typeparam>
/// <typeparam name="TDefaultSettings">The type of the default command's settings.</typeparam>
    ...
    where TDefaultSettings : CommandSettings
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CommandApp{TDefaultCommand, TDefaultSettings}"/> class.
    /// </summary>
    /// <param name="registrar">The registrar.</param>
    public CommandApp(ITypeRegistrar? registrar = null)
    {
        _app = new CommandApp(registrar);
        _defaultCommandConfigurator = _app.SetDefaultCommand<TDefaultCommand, TDefaultSettings>();
    }
    ...
    /// </summary>
    /// <param name="description">The default command description.</param>
    /// <returns>The same <see cref="CommandApp{TDefaultCommand, TDefaultSettings}"/> instance so that multiple calls can be chained.</returns>
    public CommandApp<TDefaultCommand, TDefaultSettings> WithDescription(string description)
    {
        _defaultCommandConfigurator.WithDescription(description);
        return this;
    }
    ...
    /// <param name="data">The data to pass to the default command.</param>
    /// <returns>The same <see cref="CommandApp{TDefaultCommand, TDefaultSettings}"/> instance so that multiple calls can be chained.</returns>
    public CommandApp<TDefaultCommand, TDefaultSettings> WithData(object data)
    {
        _defaultCommandConfigurator.WithData(data);
        return this;
    }
